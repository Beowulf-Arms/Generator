...
//-------------------------------------------------------------------------------------------------------------------------
	case 1:
	{
		...
		_campAmmo      = [["Box_FIA_Ammo_F",5,-5,0]];
		_campStatic    = [["B_Mortar_01_F",-5,5,0,"I_BSO_chdkz_INS"],["B_Mortar_01_F",5,5,0,"I_BSO_chdkz_INS"]];
		_campAddUnit   = ["I_BSO_chdkz_INS","I_BSO_chdkz_INS2","I_BSO_chdkz_INS","I_BSO_chdkz_MG","I_BSO_chdkz_GL"];
		_campUserObj   = [];
		_campRandomObj = [];
		_campWall      = [];
		_campObjInit   = [[],[],[],[],[],[],[]];
...
//-------------------------------------------------------------------------------------------------------------------------
	case 2:
	{
		...
		_campStatic    = [["B_Mortar_01_F",-7,25,0,"I_BSO_chdkz_INS"],["B_Mortar_01_F",25,25,0,"I_BSO_chdkz_INS"]];
		_campAddUnit   = ["I_BSO_chdkz_INS","I_BSO_chdkz_INS2","I_BSO_chdkz_INS","I_BSO_chdkz_MG","I_BSO_chdkz_GL"];
		_campUserObj   = [];
		_campRandomObj = [];
		_campWall      = [];
