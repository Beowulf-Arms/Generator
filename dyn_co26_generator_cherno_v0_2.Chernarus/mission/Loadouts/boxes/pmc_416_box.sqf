...
_this addItemCargoGlobal ["optic_Hamr",100]; 
_this addItemCargoGlobal ["rhsusf_acc_nt4_black",100];
_this addItemCargoGlobal ["NVGoggles_OPFOR",100]; 
_this addItemCargoGlobal ["ACE_wirecutter",5]; 
_this addItemCargoGlobal ["rhsusf_acc_grip2",100];
_this addItemCargoGlobal ["rhsusf_acc_grip1",100];
_this addItemCargoGlobal ["rhsusf_acc_grip3",100];
