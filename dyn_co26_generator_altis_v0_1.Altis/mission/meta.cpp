...
overviewText = "1-26<br />COOP-DYN<br />DYNAMIC<br />Unlimited<br />Advanced Medical<br />Dynamic DAC Generator - Beowulf PMC take on FIA insurgents.<br />JIP teleport to Leader<br />Walker";
...
overviewPicture = "mission\blue_jackal.jpg";								// <!-- Mission Picture (Use jpg at 1024x512 for quality/compression)
loadScreen = "mission\blue_jackal.jpg";									// <!-- Loading Screen Picture (See above)
OnLoadName = "Generator - ALTIS";									// <!-- Mission Name (Just Text)
OnLoadMission = "Dynamic DAC Generator - Beowulf PMC take on FIA insurgents."; 			// <!-- A VERY brief overview (Copy from above)
