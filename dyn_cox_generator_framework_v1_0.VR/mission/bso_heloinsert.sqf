//	nul = [_AirSpawn,_AirEnd,_Dropzone,_RallyPoint,_ParaAttack,_Side,_AircraftType,_ParatroopsArray,_AirSpawnDir] execVM "bso_paradrop.sqf";  
...
_AirWP1 = [_aircraft, (getMarkerPos _Dropzone), 0, "TR UNLOAD", "CARELESS", "BLUE", "NORMAL", "NO CHANGE"] call CBA_fnc_addWaypoint;
