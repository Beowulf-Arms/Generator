...
//-------------------------------------------------------------------------------------------------------------------------
	...
	{		
		_set0  = [20,1,0,300];
		_set1  = [2,0.1,10,[],3,30];
		_set2  = [50,10,100,500,4,5,0];
		_set3  = [["B_Mortar_01_F",["R_60mm_HE"]]];
		_set4  = [5,5,1];
		_set5  = [10,30,0];
		_set6  = [10,30,0];
		_set7  = [0.1,0.5,1];
...
//-------------------------------------------------------------------------------------------------------------------------
	case 3:
	{
		...
		_set3  = [["O_Mortar_01_F",["8Rnd_82mm_Mo_shells"]],["BSO_D30_FIA",["RDS_30Rnd_122mmHE_D30"]]];
		_set4  = [2,5,0];
		_set5  = [5,10,1];
		_set6  = [5,10,1];
		_set7  = [0.1,1,1];
		_set8  = ["arty1","arty2","arty3"];
		_set9  = [];
		_set10 = 1500;
	};
//-------------------------------------------------------------------------------------------------------------------------
