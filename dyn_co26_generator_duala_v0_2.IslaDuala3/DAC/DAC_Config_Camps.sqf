...
//-------------------------------------------------------------------------------------------------------------------------
	case 1:
	{
		...
		_campAmmo      = [["Box_FIA_Ammo_F",5,-5,0]];
		_campStatic    = [["B_Mortar_01_F",-5,5,0,"I_bso_afr_mil_INS"],["B_Mortar_01_F",5,5,0,"I_bso_afr_mil_INS"]];
		_campAddUnit   = ["I_bso_afr_mil_INS","I_bso_afr_mil_INS2","I_bso_afr_mil_INS","I_bso_afr_mil_MG","I_bso_afr_mil_GL"];
		_campUserObj   = [];
		_campRandomObj = [];
		_campWall      = [];
		_campObjInit   = [[],[],[],[],[],[],[]];
...
//-------------------------------------------------------------------------------------------------------------------------
	case 2:
	{
		...
		_campStatic    = [["B_Mortar_01_F",-7,25,0,"I_bso_afr_mil_INS"],["B_Mortar_01_F",25,25,0,"I_bso_afr_mil_INS"]];
		_campAddUnit   = ["I_bso_afr_mil_INS","I_bso_afr_mil_INS2","I_bso_afr_mil_INS","I_bso_afr_mil_MG","I_bso_afr_mil_GL"];
		_campUserObj   = [];
		_campRandomObj = [];
		_campWall      = [];
