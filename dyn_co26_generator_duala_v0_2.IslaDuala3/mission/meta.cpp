...
overviewText = "1-26<br />COOP-DYN<br />DYNAMIC<br />Unlimited<br />Advanced Medical<br />Dynamic DAC Generator - Beowulf PMC fight off African Warlords.<br />JIP teleport to Leader<br />Walker";
...
overviewPicture = "mission\gene_duala.jpg";								// <!-- Mission Picture (Use jpg at 1024x512 for quality/compression)
loadScreen = "mission\gene_duala.jpg";									// <!-- Loading Screen Picture (See above)
OnLoadName = "Generator - DUALA";									// <!-- Mission Name (Just Text)
OnLoadMission = "Dynamic DAC Generator - Beowulf PMC fight off African Warlords"; 			// <!-- A VERY brief overview (Copy from above)
