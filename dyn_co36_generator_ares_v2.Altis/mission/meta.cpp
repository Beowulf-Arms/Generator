...
overviewText = "1-29<br />DYN-COOP<br />Unlimited<br />Advanced Medical<br />Dynamic DAC Generator - Beowulf PMC take on FIA insurgents.<br />JIP teleport to Leader<br /><br />Walker";
...
OnLoadMission = "AAF SF are unleashed on the FIA insurgents"; 			// <!-- A VERY brief overview (Copy from above)

author="Walker";												// <!-- This is you!!				

class Header {
	maxPlayers = 29;						// <!-- CHANGE Where the number is the total playable slots
	minPlayers = 1;
