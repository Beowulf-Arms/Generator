...
_QrfHeloStartPosF = [(getMarkerPos "QrfHeloLZ1Mark"), 1000, _HeloStartdir] call BIS_fnc_relPos;
...
_QrfHeloEndPosF = [(getMarkerPos "QrfHeloLZ1Mark"), 1000, _HeloEnddir] call BIS_fnc_relPos;
