...
_bsoMb2 = ["bso_mission_board_2", "Destroy Weapons Cache","",{[0,{[]call gene_fnc_mission_cache},{}] call CBA_fnc_globalExecute;},{true}] call ace_interact_menu_fnc_createAction;
