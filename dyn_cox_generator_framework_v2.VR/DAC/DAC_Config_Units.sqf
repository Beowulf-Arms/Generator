...
// REDFOR (A3)
  case 0:
  {
    _Unit_Pool_S = ["O_BSO_FIA_INS","O_BSO_FIA_INS","O_BSO_FIA_GL","O_BSO_FIA_AUTO","O_BSO_FIA_MG","O_BSO_FIA_INS","O_BSO_FIA_INS3","O_BSO_FIA_INS3","O_BSO_FIA_DMR","O_BSO_FIA_DOC","O_BSO_FIA_MG","O_BSO_FIA_MECH","O_BSO_FIA_INS3","O_BSO_FIA_INS","O_BSO_FIA_INS","O_BSO_FIA_INS","O_BSO_FIA_INS3","O_BSO_FIA_INS2","O_BSO_FIA_GL"];
    _Unit_Pool_V = ["O_BSO_FIA_TRUCK","O_BSO_FIA_OFFROAD","O_BSO_FIA_Zamak","O_BSO_FIA_Zamak_open"];
    _Unit_Pool_T = ["O_BSO_FIA_OFFROAD_ARMED"];
	_Unit_Pool_A = [""];
  };
//-------------------------------------------------------------------------------------------------
// BLUFOR (A3)
