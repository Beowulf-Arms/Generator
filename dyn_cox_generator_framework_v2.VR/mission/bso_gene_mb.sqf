...
_bsoMb2 = ["bso_mission_board_2", "Destroy Weapons Cache","",{[0,{execVM "mission\gene\mission_cache.sqf"},{}] call CBA_fnc_globalExecute;},{true}] call ace_interact_menu_fnc_createAction;
_bsoMb3 = ["bso_mission_board_3", "Capture HVT","",{[0,{execVM "mission\gene\mission_c_hvt.sqf"},{}] call CBA_fnc_globalExecute;},{true}] call ace_interact_menu_fnc_createAction;
_bsoMb4 = ["bso_mission_board_4", "Eliminate HVT","",{[0,{execVM "mission\gene\mission_e_hvt.sqf"},{}] call CBA_fnc_globalExecute;},{true}] call ace_interact_menu_fnc_createAction;
...
_bsoMbC = ["bso_mission_board_C", "Clear Obj.","",{[0,{execVM "mission\gene\mission_clear.sqf"},{}] call CBA_fnc_globalExecute;},{true}] call ace_interact_menu_fnc_createAction;
